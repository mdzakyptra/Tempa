  ...
  return (
    <footer className="relative overflow-hidden border-t border-white/10">
      <Marquee speed={22} className="py-10">
        <span className="mx-6 text-6xl font-black uppercase tracking-tighter text-neutral-800 md:text-8xl">
          Let&apos;s talk —
        </span>
        <span className="mx-6 text-6xl font-black uppercase tracking-tighter text-white md:text-8xl">
      ...
      <div className="mx-auto flex max-w-6xl flex-col items-center justify-between gap-6 px-6 py-10 text-sm text-neutral-500 md:flex-row">
        <span className="font-black tracking-tighter text-white">
          MONO<span className="text-neutral-600">/</span>LITH
        </span>
