    ...
    <section className="relative border-y border-white/10 py-14">
      ...
      <Marquee speed={30} className="mb-10">
        {brands.map((b) => (
          <span
            key={b}
            className="mx-10 text-2xl font-black tracking-tighter text-neutral-500 transition-colors hover:text-white md:text-3xl"
          >
            {b}
          </span>
        ))}
      ...
      <div className="text-5xl font-black uppercase tracking-tighter text-neutral-800 md:text-7xl">
        <ScrollVelocity
