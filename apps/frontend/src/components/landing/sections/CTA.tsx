    ...
    >
      ...
      <div className="relative z-10 flex flex-col items-center">
        ...
        <MagneticButton
          ...
          strength={0.5}
          className="mt-10 rounded-full bg-white px-10 py-5 text-base font-semibold text-black"
        >
          Start a project →
        </MagneticButton>

        {/* live backend status — keeps the fe <-> be link visible */}
        <div className="mt-12 inline-flex items-center gap-2 rounded-full border border-white/15 px-4 py-2 font-mono text-xs">
          <span
