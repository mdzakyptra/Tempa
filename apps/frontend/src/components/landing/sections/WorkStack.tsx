...
const pages = [
  { number: "01", title: "Antrean laporan", eyebrow: "Laporan prioritas", caption: "Laporan yang perlu ditangani", description: "Pantau laporan warga yang paling mendesak, lengkap dengan skor prioritas dan pembaruan statusnya.", href: "/antrean" },
  { number: "02", title: "Detail laporan", eyebrow: "Transparan untuk semua", caption: "Dari laporan sampai tindak lanjut", description: "Lihat bukti, riwayat penanganan, dan alasan sebuah laporan berada di antrean saat ini.", href: "/antrean" },
  { number: "03", title: "Lapor baru", eyebrow: "Suaramu punya dampak", caption: "Satu laporan, langkah awal perubahan", description: "Kirim foto dan lokasi masalah di kotamu. Kami bantu cek laporan serupa sebelum dikirim.", href: "/lapor-baru" },
  { number: "04", title: "Metodologi", eyebrow: "Prioritas yang bisa dipahami", caption: "Cara kami menyusun antrean", description: "Pahami bobot, rumus, dan prinsip yang membuat setiap urutan laporan tetap adil dan terbuka.", href: "/metodologi" },
];
